...
#   2025.08.06  エラーが表示されるところを修正して、いらないサブルーチンやらを多少整理。
#   2025.08.19  パイソンのバージョン環境によってエラーになる？　バージョンごとにライブラリをインストールするのか？？？
#
...
def ocrLcd(image):
    ...
    #撮影時の表示の位置で設定を変更
    #if fileName < "P110169":
                    #画像のサイズ　5184 × 3888 ピクセル　　180 ピクセル/インチ
    ocrType = 5     # 0 --  2022/07/17~ 手入力  P1110155.JPG ~ P1110xxx.JPG
                    ...
                    # 5 --  2026/06/06~  P1160085.JPG ~ 3Dプリンタで筐体を製作したので表示位置が変わった
    ...
    if ocrType == 0:
        ...
        if ocrType == 5:
            # 2026/06/06~  P1160085.JPG ~ 
            lcdImage = crop(image, ( 2592, 3000) , ( 700, 450))  #中心座標、サイズ
